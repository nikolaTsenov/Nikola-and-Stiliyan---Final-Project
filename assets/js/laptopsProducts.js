	...
	xhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			...
			for (var i =0; i<ourData.length; i++){
		        htmlString +="<div class='' id='laptopsAndAcc"+i+"'><a href='../view/product.php?id="+ourData[i].id+"'>"
	...
	xhttp2.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			...
			for (var i =0; i<ourData2.length; i++){
		        htmlString2 +="<div class='' id='computers"+i+"'><a href='../view/product.php?="+ourData2[i].id+"'>"
	...
	xhttp3.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			...
			for (var i =0; i<ourData3.length; i++){
		        htmlString3 +="<div class='' id='pcComponents"+i+"'><a href='#'>"
	...
	xhttp4.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			...
			for (var i =0; i<ourData4.length; i++){
		        htmlString4 +="<div class='' id='software"+i+"'><a href='#'>"
	...
	xhttp5.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			...
			for (var i =0; i<ourData5.length; i++){
		        htmlString5 +="<div class='' id='perifery"+i+"'><a href='#'>"
	...
	xhttp6.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			...
			for (var i =0; i<ourData6.length; i++){
		        htmlString6 +="<div class='' id='printers"+i+"'><a href='#'>"
	...
	xhttp7.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			...
			for (var i =0; i<ourData7.length; i++){
		        htmlString5 +="<div class='' id='wirelessNetWorking"+i+"'><a href='#'>"
